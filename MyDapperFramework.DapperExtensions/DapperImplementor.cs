...
namespace DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        Task<bool> UpdateAsync<T>(IDbConnection connection, object parameters, object predicate, IDbTransaction transaction, int? commandTimeout, bool ignoreAllKeyProperties) where T : class;
        ...
        IEnumerable<T> GetPage<T>(IDbConnection connection,string[] fields, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
        ...
        IEnumerable<T> GetSet<T>(IDbConnection connection,string[] fields, object predicate, IList<ISort> sort, int firstResult, int maxResults, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
    ...
    public class DapperImplementor : IDapperImplementor
    {
        ...
        public async Task<bool> UpdateAsync<T>(IDbConnection connection, T entity, IDbTransaction transaction, int? commandTimeout, bool ignoreAllKeyProperties = false) where T : class
        {
            ...
            var result = await connection.ExecuteAsync(sql, dynamicParameters, transaction, commandTimeout, CommandType.Text) > 0;
            return result;
        }
        ...
        public bool Update<T>(IDbConnection connection, object parameters, object predicate, IDbTransaction transaction, int? commandTimeout, bool ignoreAllKeyProperties = false) where T : class
        {
            ...
            PropertyInfo[] propertys = parameters.GetType().GetProperties();
            Dictionary<string, object> parms = new Dictionary<string, object>();
            foreach (PropertyInfo p in propertys)
            {
                parms.Add(p.Name, p.GetValue(parameters));
            }
            string sql = SqlGenerator.Update(classMap, wherePredicate, parms, ignoreAllKeyProperties);
        ...
        public async Task<bool> UpdateAsync<T>(IDbConnection connection, object parameters, object predicate, IDbTransaction transaction, int? commandTimeout, bool ignoreAllKeyProperties = false) where T : class
        {
        ...
        public async Task<bool> DeleteAsync<T>(IDbConnection connection, object predicate, IDbTransaction transaction, int? commandTimeout) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            var result = await DeleteAsync<T>(connection, classMap, wherePredicate, transaction, commandTimeout);
            return result;
        }
        ...
        public async Task<IEnumerable<T>> GetListAsync<T>(IDbConnection connection, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            var result = await GetListAsync<T>(connection, classMap, wherePredicate, sort, transaction, commandTimeout, buffered);
            return result;
        }

        public async Task<T> GetFirstOrDefaultAsync<T>(IDbConnection connection, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            ...
            var result = await connection.QueryFirstOrDefaultAsync<T>(sql, dynamicParameters, transaction, commandTimeout, CommandType.Text);
            return result;
        }
        ...
        public IEnumerable<T> GetPage<T>(IDbConnection connection,string[] fields, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetPage<T>(connection, fields, classMap, wherePredicate, sort, page, resultsPerPage, transaction, commandTimeout, buffered);
        }
        ...
        public async Task<IEnumerable<T>> GetPageAsync<T>(IDbConnection connection, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            var result = await GetPageAsync<T>(connection, classMap, wherePredicate, sort, page, resultsPerPage, transaction, commandTimeout, buffered);
            return result;
        }
        ...
        public IEnumerable<T> GetSet<T>(IDbConnection connection,string[] fields, object predicate, IList<ISort> sort, int firstResult, int maxResults, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetSet<T>(connection,fields, classMap, wherePredicate, sort, firstResult, maxResults, transaction, commandTimeout, buffered);
        }
        ...
        protected IEnumerable<T> GetPage<T>(IDbConnection connection,string[] fields, IClassMapper classMap, IPredicate predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            string sql = SqlGenerator.SelectPaged(classMap,fields, predicate, sort, page, resultsPerPage, parameters);
            DynamicParameters dynamicParameters = new DynamicParameters();
            foreach (var parameter in parameters)
            {
                dynamicParameters.Add(parameter.Key, parameter.Value);
        ...
        protected IEnumerable<T> GetSet<T>(IDbConnection connection,string[] fields, IClassMapper classMap, IPredicate predicate, IList<ISort> sort, int firstResult, int maxResults, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            string sql = SqlGenerator.SelectSet(fields,classMap, predicate, sort, firstResult, maxResults, parameters);
            DynamicParameters dynamicParameters = new DynamicParameters();
            foreach (var parameter in parameters)
            {
                dynamicParameters.Add(parameter.Key, parameter.Value);
